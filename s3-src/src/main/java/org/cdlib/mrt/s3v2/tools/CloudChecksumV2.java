...
import org.cdlib.mrt.s3v2.action.GetObjectStream;
...
public class CloudChecksumV2 {
    ...
    public static CloudChecksumV2 getChecksums(String [] types, CloudStoreInf service, String bucket, String key)
        throws TException
    {
        CloudChecksumV2 checksums = new CloudChecksumV2(types, service, bucket, key, null);
        //checksums.process();
        return checksums;
    }
    
    public static CloudChecksumV2 getChecksums(String [] types, CloudStoreInf service, String bucket, String key, Integer maxsize)
        throws TException
    {
        CloudChecksumV2 checksums = new CloudChecksumV2(types, service, bucket, key, maxsize);
        //checksums.process();
        return checksums;
    }
    
    
    protected CloudChecksumV2(String [] types, CloudStoreInf service, String bucket, String key, Integer maxsize)
        throws TException
    {
        ...
        throws TException
    {
        ...
        try {
            ...
            CloudChecksumV2 cloudChecksum = CloudChecksumV2.getChecksums(types, service, bucket, testKey);
        ...
        throws TException
    {
        if (!(service instanceof AWSS3V2Cloud)) {
            throw new TException.INVALID_DATA_FORMAT("AWS v2 required");
        
        }
        InputStream inputStream = null;
        try {
            AWSS3V2Cloud v2S3 = (AWSS3V2Cloud)service;
            S3Client s3Client = v2S3.getS3Client();
            inputStream = GetObjectStream.getObjectStream(s3Client, bucket, key);
            return inputStream;
