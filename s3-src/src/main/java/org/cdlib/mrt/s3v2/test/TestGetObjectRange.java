...
public class TestGetObjectRange {
            ...
            throws TException
    {
        ...
        test_aws_download(keyBig, 7000000001L, 7000000101L);
    ...
    public static void test_aws_download(String key, Long startByte, Long endByte)
            throws TException
    { 
       ...
       public static void test_wasabi_download(String key, Long startByte, Long endByte)
            throws TException
    { 
    ...
    public static void test_minio_download(String key, Long startByte, Long endByte)
            throws TException
    { 
    ...
    protected static Properties doGetObjectRange(
            V2Client v2client,
            String bucketName,
            String key,
            String downFilePrefix,
            Long startByte,
            Long endByte)
        throws TException
    {
        ...
        String downFilePath = downFilePrefix + " -" + startByte + "-" + endByte + ".txt";
        ...
        InputStream inputStream = GetObjectRange.getObjectRange(s3Client, bucketName, key, startByte, endByte);
        FileUtil.stream2File(inputStream, downFile);
        File downFileAfter = new File(downFilePath); 
        if (!downFileAfter.exists()) {
            System.out.println("NO FILE:" + downFilePath);
            return null;
        }
        long downloadSize = downFileAfter.length();
        long inputSize = endByte - startByte + 1;
