...
public class V2ClientSave {
    ...
    public static V2ClientSave getMinio(String accessKey, String secretKey, String endpoint)
        throws TException
    {
        V2ClientSave minioClient = new V2ClientSave(V2ClientSave.S3Type.minio, Region.US_WEST_2, accessKey, secretKey, endpoint);
        return minioClient;
    }
    
    public static V2ClientSave getSDSC(String accessKey, String secretKey, String endpoint)
        throws TException
    {
        V2ClientSave minioClient = new V2ClientSave(V2ClientSave.S3Type.sdsc, Region.US_WEST_2, accessKey, secretKey, endpoint);
        return minioClient;
    }
    
    public static V2ClientSave getWasabi(String accessKey, String secretKey, String endpoint)
        throws TException
    {
        V2ClientSave wasabioClient = new V2ClientSave(V2ClientSave.S3Type.wasabi, Region.US_EAST_2, accessKey, secretKey, endpoint);
        return wasabioClient;
    }
    
    public static V2ClientSave getAWS()
        throws TException
    {
        V2ClientSave awsClient = new V2ClientSave(V2ClientSave.S3Type.aws, Region.US_WEST_2);
        return awsClient;
    }
    
    protected V2ClientSave(S3Type s3Type, Region region, String accessKey, String secretKey, String endPoint)
        throws TException
    {
        this.s3Type = s3Type;
    ...
    protected V2ClientSave(S3Type s3Type,  Region region)
        throws TException
    {
        this.s3Type = s3Type;
