...
public class TestS3RetrieveTag {
    ...
    public TestS3RetrieveTag(LoggerInf logger) 
        throws TException
    {
            ...
            throws TException
    {
        ...
        TestS3RetrieveTag testRetrieve = new TestS3RetrieveTag(logger);
        
        S3Retrieve retrieve = S3Retrieve.getS3Retrieve(logger);
        testRetrieve.testTag2();
        /*
        for (String url, urls) {
            processUrl(url);
        }
*/
    ...
    public void testTag()
       throws TException
    {
        retrieve.addTag("group.xx/key.2.txt", "STATUS", "COMPLETE");
        retrieve.addTag("group.xx/key.2.txt", "sha256", "c0db6d826f0ef837ad2679998dbc8c21c3e945aa10ea3f5eb8cbd7f71e1d2f6f");
    }
    
    public void testTag2()
       throws TException
    {
        retrieve.setPrefixTag("group.3/", "STATUS", "COMPLETE");
    }
