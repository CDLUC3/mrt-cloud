 ...
 */
public class ComponentListManifest {
        ...
        throws TException
    {
        ...
        try {
            ...
            for (int v=1; v <= current; v++) {
                buildCloudList(versionMap, cloudList, v);
            }
            return cloudList;
    ...
    public CloudList buildCloudList(String arkS, int version)
        throws TException
    {
        ...
        try {
            ...
            if (version < 0) {
                ...
                buildCloudList(versionMap, cloudList, current);
                
            } else {
                buildCloudList(versionMap, cloudList, version);
            }
            return cloudList;
    ...
    public void buildCloudList(VersionMap versionMap, CloudList cloudList, int version)
        throws TException
    {
